  ...
  useEffect(() => {
    const handleScroll = () => {
      if (parallaxRef.current) {
        ...
        // Parallax effect: Move element down at 12% of scroll speed to create depth
      ...
      <main className="max-w-[1600px] mx-auto px-4 sm:px-6 md:px-8 pb-20">
        ...
        <section id="vien-canh-tuong-lai" className="py-12 scroll-mt-28">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-accent-orange rounded-4xl p-8 text-white relative group overflow-hidden min-h-[320px] flex flex-col justify-between transition-all duration-300 hover:scale-[1.03] hover:shadow-2xl hover:shadow-orange-500/20 cursor-default">
            ...
            <div className="bg-accent-purple rounded-4xl p-8 text-white relative group overflow-hidden min-h-[320px] flex flex-col justify-between transition-all duration-300 hover:scale-[1.03] hover:shadow-2xl hover:shadow-purple-500/20 cursor-default">
              <div className="absolute top-0 right-0 p-8 opacity-20 transform group-hover:scale-150 transition-transform duration-500">
                <BarChart3 size={120} />
              </div>
              <div className="bg-white/20 w-12 h-12 rounded-xl flex items-center justify-center backdrop-blur-sm mb-6">
            ...
            <div className="bg-accent-green rounded-4xl p-8 text-accent-dark relative group overflow-hidden min-h-[320px] flex flex-col justify-between transition-all duration-300 hover:scale-[1.03] hover:shadow-2xl hover:shadow-green-500/20 cursor-default">
              <div className="absolute top-0 right-0 p-8 opacity-20 transform group-hover:scale-150 transition-transform duration-500">
                <Users size={120} />
              </div>
