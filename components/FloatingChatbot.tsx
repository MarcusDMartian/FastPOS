...
export const FloatingChatbot: React.FC = () => {
  ...
  return (
    <>
      ...
      <button
        onClick={toggleChat}
        className={`fixed bottom-6 right-6 z-50 p-4 rounded-full shadow-2xl transition-all duration-300 hover:scale-110 flex items-center justify-center ${isOpen ? 'bg-white text-gray-800 rotate-90' : 'bg-gradient-to-r from-accent-orange to-red-500 text-white'
          }`}
